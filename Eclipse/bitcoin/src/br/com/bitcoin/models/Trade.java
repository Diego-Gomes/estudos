...
public class Trade {
	...
	private final float unit_price; // Preço da unidade da moeda (FLOAT)
	private final String active_order_code; // Código da ordem ativa (STRING)
	private final String passive_order_code; // Código da ordem passiva (STRING)
